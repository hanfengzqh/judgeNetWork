    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                switch (itemViewType) {
                    case KEY_1:
                        convertView = LayoutInflater.from(DownloadListActivity.this).inflate(R.layout.activity_downloadlist_downloadingtab, null);
                        holder = new Hodler1();
                        ((Hodler1) holder).act_downloadlist_tv_ing = (TextView) convertView.findViewById(R.id.act_downloadlist_tv_ing);
                        break;
                    case KEY_2:
                        convertView = LayoutInflater.from(DownloadListActivity.this).inflate(R.layout.activity_downloadlist_downloadfinishtab, null);
                        holder = new Hodler2();
                        ...
                        break;
                    case KEY_3:
                        convertView = View.inflate(DownloadListActivity.this, R.layout.activity_list_view_item, null);
                        holder = new Hodler3();
