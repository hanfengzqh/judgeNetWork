package com.zng.synchronousdownload.download;
...
import com.zng.synchronousdownload.MainActivity;
...
public class DownloadManager {
    ...
    private void showCustomProgressNotify(DownloadInfo downloadInfo) {
        ...
        mRemoteViews.setImageViewResource(R.id.iv_image, R.drawable.app_logo);
